...
use mzdata::params::{
    ...
    Unit, CURIE as CURIEImpl,
};
use mzdata::spectrum::{
    Acquisition as AcquisitionImpl, HasIonMobility, IsolationWindow as IsolationWindowImpl,
...
impl MZReader {
    ...
    pub fn has_ion_mobility_dimension(&mut self) -> bool {
        matches!(
            self.0.has_ion_mobility().unwrap_or_default(),
...
impl Spectrum {
    ...
    pub fn pick_peaks(&mut self, signal_to_noise_threshold: f32) {
        self.0.pick_peaks(signal_to_noise_threshold).unwrap();
    }
    ...
    pub fn peak(&self, index: usize, peak: &mut ffi::Peak) -> bool {
        if let Some(p) = self.0.peaks().get(index) {
            peak.mz = p.mz;
    ...
    pub fn precursor(&self) -> Result<Box<Precursor<'_>>, &'static str> {
...
impl IonMobilityFrame {
    ...
    pub fn ion_mobility_unit(&self) -> ffi::Unit {
        self.0.ion_mobility_unit().into()
    }
    ...
    pub fn signal_into(
        ...
        mut mzs_container: Pin<&mut CxxVector<f64>>,
        mut intensities_container: Pin<&mut CxxVector<f32>>,
        mut ion_mobility_container: Pin<&mut CxxVector<f64>>,
    ) -> Result<usize, String> {
        let arrays = match self.0.features() {
            mzdata::spectrum::RefFeatureDataLevel::Missing => {
                return Ok(0);
            }
            mzdata::spectrum::RefFeatureDataLevel::RawData(binary_array_map3_d) => {
                let arrays = binary_array_map3_d.unstack().unwrap();
                arrays
            }
            mzdata::spectrum::RefFeatureDataLevel::Centroid(feature_map) => {
                BuildArrayMap3DFrom::as_arrays_3d(feature_map.as_slice())
                    .unstack()
                    .unwrap()
            }
        ...
        let mzs = arrays.mzs().map_err(|e| e.to_string())?;
        for val in mzs.iter().copied() {
            mzs_container.as_mut().push(val);
        }

        let intensities = arrays.intensities().map_err(|e| e.to_string())?;
        for val in intensities.iter().copied() {
            intensities_container.as_mut().push(val);
        }

        let (ion_mobilities, _kind) = arrays.ion_mobility().map_err(|e| e.to_string())?;
        for val in ion_mobilities.iter().copied() {
            ion_mobility_container.as_mut().push(val);
        }
...
impl From<Unit> for ffi::Unit {
    fn from(value: Unit) -> Self {
        match value {
            Unit::Unknown => ffi::Unit::Unknown,
            Unit::MZ => ffi::Unit::MZ,
            Unit::Mass => ffi::Unit::Mass,
            Unit::PartsPerMillion => ffi::Unit::PartsPerMillion,
            Unit::Nanometer => ffi::Unit::Nanometer,
            Unit::Minute => ffi::Unit::Minute,
            Unit::Second => ffi::Unit::Second,
            Unit::Millisecond => ffi::Unit::Millisecond,
            Unit::VoltSecondPerSquareCentimeter => ffi::Unit::VoltSecondPerSquareCentimeter,
            Unit::DetectorCounts => ffi::Unit::DetectorCounts,
            Unit::PercentBasePeak => ffi::Unit::PercentBasePeak,
            Unit::PercentBasePeakTimes100 => ffi::Unit::PercentBasePeakTimes100,
            Unit::AbsorbanceUnit => ffi::Unit::AbsorbanceUnit,
            Unit::CountsPerSecond => ffi::Unit::CountsPerSecond,
            Unit::Electronvolt => ffi::Unit::Electronvolt,
            Unit::Volt => ffi::Unit::Volt,
            Unit::Celsius => ffi::Unit::Celsius,
            Unit::Kelvin => ffi::Unit::Kelvin,
            Unit::Pascal => ffi::Unit::Pascal,
            Unit::Psi => ffi::Unit::Psi,
            Unit::MicrolitersPerMinute => ffi::Unit::MicrolitersPerMinute,
            Unit::Percent => ffi::Unit::Percent,
            Unit::Dimensionless => ffi::Unit::Dimensionless,
        }
    }
}

impl From<ffi::Unit> for Unit {
    fn from(value: ffi::Unit) -> Self {
        match value {
            ffi::Unit::Unknown => Unit::Unknown,
            ffi::Unit::MZ => Unit::MZ,
            ffi::Unit::Mass => Unit::Mass,
            ffi::Unit::PartsPerMillion => Unit::PartsPerMillion,
            ffi::Unit::Nanometer => Unit::Nanometer,
            ffi::Unit::Minute => Unit::Minute,
            ffi::Unit::Second => Unit::Second,
            ffi::Unit::Millisecond => Unit::Millisecond,
            ffi::Unit::VoltSecondPerSquareCentimeter => Unit::VoltSecondPerSquareCentimeter,
            ffi::Unit::DetectorCounts => Unit::DetectorCounts,
            ffi::Unit::PercentBasePeak => Unit::PercentBasePeak,
            ffi::Unit::PercentBasePeakTimes100 => Unit::PercentBasePeakTimes100,
            ffi::Unit::AbsorbanceUnit => Unit::AbsorbanceUnit,
            ffi::Unit::CountsPerSecond => Unit::CountsPerSecond,
            ffi::Unit::Electronvolt => Unit::Electronvolt,
            ffi::Unit::Volt => Unit::Volt,
            ffi::Unit::Celsius => Unit::Celsius,
            ffi::Unit::Kelvin => Unit::Kelvin,
            ffi::Unit::Pascal => Unit::Pascal,
            ffi::Unit::Psi => Unit::Psi,
            ffi::Unit::MicrolitersPerMinute => Unit::MicrolitersPerMinute,
            ffi::Unit::Percent => Unit::Percent,
            ffi::Unit::Dimensionless => Unit::Dimensionless,
            _ => Unit::Unknown,
        }
    }
}
...
pub(crate) mod ffi {
    ...
    extern "Rust" {
        ...
        pub fn pick_peaks(&mut self, signal_to_noise_threshold: f32);
        pub fn len(&self) -> usize;
        pub fn peak(&self, index: usize, peak: &mut Peak) -> bool;
